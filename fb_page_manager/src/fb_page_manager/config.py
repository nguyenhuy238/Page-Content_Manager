...
GEMINI_MODEL: str = _first_env("GEMINI_MODEL", "CLAUDE_MODEL", default="gemini-2.5-flash")
...
def reload_config() -> None:
    ...
    GEMINI_MODEL = _first_env("GEMINI_MODEL", "CLAUDE_MODEL", default="gemini-2.5-flash")
